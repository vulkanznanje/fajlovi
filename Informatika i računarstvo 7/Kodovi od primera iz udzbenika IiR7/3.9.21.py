...
pg.draw.line(prozor, pg.Color("Black"), (x+a/2, y+h),(x-a/4, y+h/2), 1)
r = round(1/3*h) #poluprečnik upisane kružnice
R = round(2/3*h) #poluprečnik opisane kružnice
#Upisana kružnica
pg.draw.circle(prozor, pg.Color("Grey"), (x,y+R), r, 1)
#Opisana kružnica
pg.draw.circle(prozor, pg.Color("DarkGrey"), (x,y+R), R, 1)
pg.display.update()
